...
def preprocess(data_path:str):
    ...
    speaker_paths = glob.glob('/work1/s183921/speaker_data/Spraakbanken-Raw/da_0611_test/*/*/*/speech/*/*/*/r*') 
    for sp in speaker_paths:
        ...
        if not isdir(out_speaker):
            ...
            if len(wav_files) > 1:
                ...
                spl_file = glob.glob(
                        f'/work1/s183921/speaker_data/Spraakbanken-Raw/da_0611_test/*/*/*/data/*/*/*/{speaker_id}.spl')[0]

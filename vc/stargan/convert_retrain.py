...
class TestDataset(object):
    ...
    def __init__(self, config):
        ...
        # self.trg_spk_stats = np.load(join('/work1/s183921/preprocessed_data/stargan/spraakbanken/mc-Test/train', f'{config.trg_spk}_stats.npz'))  # Changed to test dir
        self.trg_spk_stats = np.load(join('../../../preprocessed_data/stargan/spraakbanken/mc-Test/train',
                                          f'{config.trg_spk}_stats.npz'))  # Changed to test dir

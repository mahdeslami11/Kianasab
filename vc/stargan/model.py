...
class Generator(nn.Module):
    """Generator network."""
    def __init__(self, conv_dim=64, num_speakers=25, repeat_num=6):  # Specified
...
class Discriminator(nn.Module):
    ...
    def __init__(self, input_size=(36, 256), conv_dim=64, repeat_num=5, num_speakers=25):  # Specified
